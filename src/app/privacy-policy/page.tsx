  ...
  return (
    <div className="bg-background text-foreground">
      <div className="container mx-auto max-w-4xl py-12 px-4 md:py-24">
        ...
        <div className="p-4 bg-destructive/10 border-l-4 border-destructive rounded-md my-8 text-sm">
            <h3 className="font-bold text-base mb-2">Disclaimer</h3>
            <p>This privacy policy is a template generated by an AI assistant and is for informational purposes only. It is not a substitute for professional legal advice. You must have this policy reviewed by a qualified legal professional to ensure it meets all legal requirements for your specific circumstances and complies fully with the POPIA Act.</p>
        </div>
